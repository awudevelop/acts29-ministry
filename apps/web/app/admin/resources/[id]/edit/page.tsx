...
export default function EditResourcePage() {
  ...
  const [formData, setFormData] = React.useState<FormData>(() => {
    ...
    const hours = (resource.hours as Record<string, string>) || {};
    ...
    return {
      ...
      currentAvailability: resource.current_availability?.toString() || '',
  ...
  return (
    <div className="space-y-6">
      <Breadcrumbs
        items={[
          { label: 'Resources', href: '/admin/resources' },
          { label: resource.name, href: `/admin/resources/${resource.id}` },
          { label: 'Edit' },
        ]}
      />
