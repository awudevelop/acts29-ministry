      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-gray-600">
            Set up a new team for collaboration and scoped access
          </p>
        </div>
      </div>
              ...
              >
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div className="sm:col-span-2">
                    ...
                    />
                    <p className="mt-1 text-sm text-gray-500">URL-friendly identifier (auto-generated)</p>
                  </div>
                  <div className="sm:col-span-2">
                    <Select
                      label="Organization"
            ...
            <div className="rounded-xl border bg-gray-50 p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-start gap-2">
                  ...
                  Choose a descriptive name that reflects the team's purpose.
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-primary-600">•</span>
                  Select a unique color to help identify the team at a glance.
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-primary-600">•</span>
                ...
                <li className="flex items-start gap-2">
                  <span className="text-primary-600">•</span>
                  Teams help scope access to resources, shifts, and content.
                </li>
              </ul>
            </div>
          </div>
